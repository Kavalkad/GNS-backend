...
namespace GNS.Services.Interfaces
{
    ...
    {
        Task AddAsync(CreateCyberClubRequest request, CancellationToken token = default);
        ...
        Task<CyberClubEntity> GetClubByIdAsync(Guid cyberClubId, CancellationToken token = default);
